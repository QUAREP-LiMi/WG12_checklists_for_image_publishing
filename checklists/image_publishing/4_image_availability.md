...
- Pictures at an exhibition: [How to share your imaging data.](https://onlinelibrary.wiley.com/doi/10.1111/jmi.13221)
...
<!-- Images are freely downloadable (public databse) -->
...
<!-- Image files are in dedicated image database (added value database or image archive) -->
